...
Visualización clara mediante zonas de calor

Clasificación de empresas según nivel de riesgo

Exportación de resultados a formato PDF
...
Identificar empresas o activos críticos
...
El sistema permite generar reportes en formato PDF, los cuales incluyen:
...
Ejecutar el análisis de criticidad

Generar la visualización por zonas de calor
